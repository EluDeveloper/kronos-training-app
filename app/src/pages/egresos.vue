...
const canManage = computed(() => session.can('expensesManage'))
...
<template>
  <PageHeader
    title="Egresos"
    eyebrow="Finanzas"
    description="Gastos operativos, compromisos y estado real de caja."
  >
    <template
      v-if="canManage"
      #actions
    ...
    <VCardText>
      <VRow class="mb-2">
        ...
        >
          <VTextField
            v-model="search"
            label="Buscar categoría, descripción o subcategoría"
        ...
        >
          <VSelect
            ...
            :items="[{title:'Pagado',value:'paid'},{title:'Pendiente',value:'pending'},{title:'Programado',value:'scheduled'}]"
            label="Estado"
            clearable
          />
        </VCol>
      ...
      <EmptyState
        ...
        icon="ri-money-dollar-circle-line"
        title="Sin egresos"
        description="Registra gastos pagados o programados o cambia los filtros."
      />
      <template v-else>
        <VTable class="text-no-wrap">
          <thead><tr><th>FECHA</th><th>CATEGORÍA</th><th>DESCRIPCIÓN</th><th>MÉTODO</th><th>ESTADO</th><th>MONTO</th><th /></tr></thead>
          <tbody>
            <tr
            ...
            >
              ...
              </td><td>{{ expense.description }}</td><td>{{ expense.method }}</td><td>
                <VChip
                  size="small"
  ...
  >
    ...
    >
      <VCardItem
        ...
        subtitle="Información del movimiento y estado del pago."
      />
