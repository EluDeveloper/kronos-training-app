...
test('uses a fixed demo project and loopback endpoints', () => {
  ...
  assert.equal(FIREBASE_EMULATOR_DATABASE_INSTANCE, 'demo-kronos-training-default-rtdb')
  ...
  assert.equal(options.databaseURL, 'http://127.0.0.1:9000?ns=demo-kronos-training-default-rtdb')
